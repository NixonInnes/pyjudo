...
- Disposable services:
  ...
  - Provides an `IDisposable` abstract to prevent the use of "disposed" instances.

- Factories:
  - Supports registering service factories.
  - Supports adding dependencies as factories.
